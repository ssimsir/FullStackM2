  ...
  return (
    <div className="app">
      ...
      <div>
        ...
        <button className="counter-button positive" onClick={()=> dispach(arttirma())}>increase</button>

        {/* <button className="counter-button zero" onClick={()=> dispach({type:sil})}>reset</button> */}
        <button className="counter-button zero" onClick={()=> dispach(silme())}>reset</button>
        {/* <button className="counter-button negative" onClick={()=> dispach({type:azalt})}>decrease</button> */}
        <button className="counter-button negative" onClick={()=> dispach(azaltma())}>decrease</button>
      </div>
    </div>
  )
}
